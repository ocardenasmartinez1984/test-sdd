...
/**
 * Respuesta de autenticación devuelta por el backend tras login/registro:
 * token JWT y datos del usuario. Se persiste en `localStorage`.
 */
...
/**
 * Servicio de autenticación y gestión de sesión del mantenedor de Usuarios.
 *
 ...
 * automático de la sesión (10 minutos), cerrando sesión y redirigiendo a
 * `/login` al expirar.
 */
